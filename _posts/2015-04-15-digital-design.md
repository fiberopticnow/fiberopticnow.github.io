...
<ul>
  ...
  <li> <b>Design Challenge: </b> Create an Animated Digital Sticker Pack </li>
</ul>
...
{% include image.html url="/media/luca.gif" width="30%" description="Some examples from the Goldfish sticker pack by Luca" %}
...
<img src="/media/kybefore.png" width="33%" style="float:left" />

{% include image.html url="/media/kyafter.gif" width="70%" description="Ky changed his original black and white images to colorful animated GIFs based on expert feedback" %}
