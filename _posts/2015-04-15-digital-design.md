...
{% include image.html url="/media/kyafter.gif" width="45%" description="Ky changed his original black and white images to colorful animated GIFs based on expert feedback" %}
