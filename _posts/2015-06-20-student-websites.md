...
{% include image.html url="/media/alex.png" width="80%" description="A really well designed layout by the Alex" %}
...
{% include image.html url="/media/kottongraphics.png" width="80%" description="Great job on the website, Gabi!" %}
